        ...
        <div className="flex items-center justify-between h-20">
          ...
          <a href="#inicio" className="flex items-center gap-3 flex-shrink-0">
            ...
            <div className="hidden sm:block">
              ...
              <span
                className="block text-xs leading-tight max-w-[200px]"
                style={{ color: '#6b7280' }}
              >
                Transporte Assistido Familiar e Intermediação de Convivência
              </span>
            </div>
          </a>
          ...
          <div className="hidden lg:flex items-center gap-1">
            <a
              href="#inicio"
              className="px-3 py-2 text-sm font-medium transition-colors duration-300 hover:text-[#C89B3C]"
            ...
            >
              <button
                className="flex items-center px-3 py-2 text-sm font-medium transition-colors duration-300 hover:text-[#C89B3C]"
                style={{ color: linkColor, fontFamily: 'var(--font-sans)' }}
              ...
              <div
                className={`absolute top-full left-0 mt-1 w-60 bg-white rounded-lg shadow-xl border border-gray-100 py-1 transition-all duration-200 ${
            ...
            >
              ...
              <div
                className={`absolute top-full left-0 mt-1 w-56 bg-white rounded-lg shadow-xl border border-gray-100 py-1 transition-all duration-200 ${
                  dropdownOpen === 'info'
                    ? 'opacity-100 translate-y-0 pointer-events-auto'
                    : 'opacity-0 -translate-y-2 pointer-events-none'
                }`}
            ...
            <a
              ...
              className="flex items-center gap-2 ml-2 px-5 py-2.5 rounded-md text-white text-sm font-bold hover:opacity-90 transition-all duration-300"
              style={{
