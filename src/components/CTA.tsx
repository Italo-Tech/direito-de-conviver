        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              >
                Precisa de atendimento ou informações sobre nossos serviços?
              </h3>
              <p
          ...
          <a
            ...
            className="flex items-center gap-3 px-8 py-4 rounded-md font-bold whitespace-nowrap hover:opacity-90 transition-opacity"
            style={{
